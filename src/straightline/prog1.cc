...
A::Stm *Prog() {
  ...
  auto exp_list1 =
      new A::PairExpList(new A::IdExp("a"), new A::LastExpList(op_exp1));
...
A::Stm *ProgProg() {
  ...
  auto exp_list2 = new A::PairExpList(
      new A::IdExp("a"),
  ...
  return new A::CompoundStm(
      stm1,
      new A::CompoundStm(ass_stm1, new A::CompoundStm(ass_stm2, pr_stm2)));
}
