...
void Roots::CheckDefAndUse(assem::Instr *instr, int  &def, int &use, bool &found_def, bool &found_use) {
...
void Roots::HandleCallRelatedPointer() {
...
std::vector<PointerMap> Roots::generatePointerMap() {
  AddressLiveness();
  TempLiveness();
